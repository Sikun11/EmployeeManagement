        ...
        <!-- Page Content -->
            ...
            <div class="container mt-4">
                ...
                <div class="card mb-4">
					...
					<div class="row mb-3">
						<div class="col">
							<label for="employeId" class="form-label">Employee Id</label> <input
								type="text" class="form-control border border-warning" name="id"
					...
					<div class="row mb-3">
						<div class="col">
							...
							<input type="text" class="form-control border border-warning"
								name="position" id="employeePosition" required>
						</div>
						<div class="col-6">
							<label for="employeeDepartment" class="form-label">Department</label>
							<input type="text" class="form-control border border-warning"
								name="department" id="employeeDepartment" required>
						</div>
					</div>
					<div class="row mb-3">
						<div class="col">
						...
						<div class="col">
							<label for="employeeEmail" class="form-label">Email</label> <input
								type="email" class="form-control border border-warning"
								name="email" id="employeeEmail" required>
						</div>
					</div>

					<input type="submit" id="submitBtn" class="btn" value="Add Employee">
					<a href="home.jsp" id="resetBtn" class="btn " style="margin-left: 3rem">reset</a>
				</form>
                    </div>
                </div>
